...
# Create Clock
#**************************************************************
create_clock -name OSC_50_B3B -period 50MHz [get_ports OSC_50_B3B]
create_clock -name OSC_50_B3D -period 50MHz [get_ports OSC_50_B3D]
create_clock -name OSC_50_B4A -period 50MHz [get_ports OSC_50_B4A]
create_clock -name OSC_50_B4D -period 50MHz [get_ports OSC_50_B4D]
create_clock -name OSC_50_B7A -period 50MHz [get_ports OSC_50_B7A]
create_clock -name OSC_50_B7D -period 50MHz [get_ports OSC_50_B7D]
create_clock -name OSC_50_B8A -period 50MHz [get_ports OSC_50_B8A]
create_clock -name OSC_50_B8D -period 50MHz [get_ports OSC_50_B8D]

create_clock -name pcie_refclk -period 100MHz [get_ports pcie_refclk]
